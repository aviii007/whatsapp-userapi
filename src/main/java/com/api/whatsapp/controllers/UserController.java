package com.api.whatsapp.controllers;


import com.api.whatsapp.dto.ResponseDto;
import com.api.whatsapp.entities.User;
import com.api.whatsapp.repositories.UserRepository;
    ...
    public ResponseEntity<User> checkLogin(@RequestBody User tryUser){
        ...
        if (correctUser.isPresent()){
            if (correctUser.get().getPassword().equals(tryUser.getPassword())){
                ResponseDto responseDTO = new ResponseDto("User Available", tryUser);
                return new ResponseEntity(responseDTO,HttpStatus.OK);
            }
        }
        ResponseDto responseDTO = new ResponseDto("User Not Found", tryUser);
